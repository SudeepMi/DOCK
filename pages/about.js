...
const About = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen mt-28 text-justify mx-auto px-12 max-w-4xl">
            <h1 className="pb-2 border-b-2 border-blue-800 text-3xl capitalize">THIS IS NOT A GOOGLE DOCS CLONE</h1>
            ...
            <div className="pt-1">
                ...
                <a href="https://github.com/Navratan123" target="_blank" rel="noreferrer">
                    <button className="ml-2 bg-gray-300 hover:bg-gray-200 py-2 px-4 rounded inline-flex items-center align-middle" type="button">
                        ...
                        <span>Navaratna Sah</span>
                    </button>
                </a>
                <br /><br />
            </div>
            <div>
                <h1 className='text-bold my-2 text-2xl capitalize'>Some the refrence web application are as follows: </h1>
                        <ol>
                            <li>
                            ...
                            <li>
                                <a href='https://www.onlinetexteditor.com/'>
                ...
                <span className="my-3 cursor-pointer text-blue-800 hover:underline" onClick={() => router.push(`/`)}>Login</span> using your google account to get started.
            </div>
        </div>
    );
}
